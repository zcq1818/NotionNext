...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '秦皇岛旅游攻略', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '奥术大师多🍚', // 作者简介
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '冀ICP备16026346号', // 备案号 闽ICP备XXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '秦皇岛旅游攻略', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '秦皇岛旅游攻略分享', // 站点描述，被notion中的页面描述覆盖
